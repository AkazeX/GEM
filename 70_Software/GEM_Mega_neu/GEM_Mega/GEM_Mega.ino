...
if(Serial1.availableForWrite()>=16)
{
  ...
  if(bGlassDown != bComGlasDown)
  {
    if(bGlassDown)
    {
      Serial1.print("StartPict.GlasDown.bco=2016");
      Serial1.write(0xFF);
      Serial1.write(0xFF);
      Serial1.write(0xFF);
      bComGlasDown = true;
    ...
    {
      Serial1.print("StartPict.GlasDown.bco=48631");
      Serial1.write(0xFF);
      Serial1.write(0xFF);
      Serial1.write(0xFF);
      bComGlasDown = false;
  ...
  if(bGlassPresent != bComGlasPresent)
  {
    if(bGlassPresent)
    {
      Serial1.print("StartPict.GlasPresent.bco=2016");
      Serial1.write(0xFF);
      Serial1.write(0xFF);
      Serial1.write(0xFF);
    ...
    {
      Serial1.print("StartPict.GlasPresent.bco=48631");
      Serial1.write(0xFF);
      Serial1.write(0xFF);
      Serial1.write(0xFF);
      bComGlasPresent = false;
  ...
  if(bLiquidDown != bComLiquidDown)
  {
    if(bLiquidDown)
    {
      Serial1.print("StartPict.BottleDown.bco=2016");
      Serial1.write(0xFF);
      Serial1.write(0xFF);
      Serial1.write(0xFF);
      bComLiquidDown = true;
    ...
    {
      Serial1.print("StartPict.BottleDown.bco=48631");
      Serial1.write(0xFF);
      Serial1.write(0xFF);
      Serial1.write(0xFF);
      bComLiquidDown = false;
  ...
  if(iState != iComState)
  {
      ...
      Serial1.write(0xFF);
      Serial1.write(0xFF);
      Serial1.print("AutoPict.Step.val="+String(iState));
      Serial1.write(0xFF);
      Serial1.write(0xFF);
      Serial1.write(0xFF);
      ...
      Serial1.write(0xFF);
      Serial1.write(0xFF);
      Serial1.print("AutoPict.LastStep.val="+String(iLastState));
      Serial1.write(0xFF);
      Serial1.write(0xFF);
      Serial1.write(0xFF);
